...
The Media Analytics (MA) extension adds the core JavaScript Media SDK (Media 3.x SDK). This extension provides the functionality for adding the `Media` tracker instance to a tags site or project. The MA extension requires two additional extensions:
...
After you have included all three of the extensions mentioned above in your tags project, you can proceed in one of two ways:
