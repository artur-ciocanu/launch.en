...
- Fixed an issue with document and window global objects in the Adobe Experience Platform Data Collection tag extension by replacing the Data Collection tags global object dependencies with direct references to them. 
