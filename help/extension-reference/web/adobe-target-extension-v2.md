...
* Body hiding must also be enabled in the Page Load Request action in the Page Load rule you use for Target in tags; otherwise, all Page loads remain hidden for the timeout period.
