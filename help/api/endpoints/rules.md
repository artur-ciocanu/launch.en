...
>[!NOTE]
>
>This document covers how to manage rules in the Reactor API. For information on how to interact with rules in the Data Collection UI, refer to the [UI guide](../../launch-reference/managing-resources/rules.md).
