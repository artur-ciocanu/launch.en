...
>[!NOTE]
>
>This document covers how to manage rule components in the Reactor API. For details on how to interact with rules and rule components in the Data Collection UI, please refer to the [UI guide](../../launch-reference/managing-resources/rules.md).
